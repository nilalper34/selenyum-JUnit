...
public class C05_ReadExcel {
    ...
    public void readExcelTesti() throws IOException {
        ...
        // sayfa 2'ye gidip
        // satir sayisinin 19 , kullanilan satir sayisinin ise 8 oldugunu test edin

        int sonSatirIndex=workbook
                .getSheet("Sayfa2")
                .getLastRowNum();

        int expectedSatirSayisi=19;
        Assert.assertEquals(expectedSatirSayisi,sonSatirIndex+1);


        int kullanilanSatirSayisi= workbook
                .getSheet("Sayfa2")
                .getPhysicalNumberOfRows();  //kullanılan satır sayısını veriri

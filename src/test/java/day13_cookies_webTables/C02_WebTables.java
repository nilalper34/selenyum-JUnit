...
public class C02_WebTables extends A_testBase {
    ...
    public void webTable() {
        ...
        //  Tum body'i bir String olarak yazdirmak isterseniz, body webElementini locate edip, getText() method'u ile yazdirabilirsiniz
